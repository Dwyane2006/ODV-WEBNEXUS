...
(function() {
    ...
    // Photos that were previously shown in the standalone Gallery section
    // live in img/gallery/ — grouped here into events by filename.
    var BASE2 = 'img/gallery/';

    function imgs2(name, start, end, ext) {
        var arr = [];
        for (var i = start; i <= end; i++) {
            arr.push(BASE2 + name + i + (ext || '.jpg'));
        }
        return arr;
    }
    ...
    var EVENTS = {
        '2025': [
            ...
            {
                name: 'Agsur Future 2025 SDG 17',
                label: 'Outside Campus',
                type: 'outside',
                images: imgs2('AGSUR FUTURE  2025 SDG 17 (', 1, 89, ').jpg')
            },
            {
                name: '2nd Batch 2025',
                label: 'Outside Campus',
                type: 'outside',
                images: imgs2('2ND BATCH 2025 (', 1, 80, ').jpg')
            },
            {
                name: '3rd Batch Sessions 2025',
                label: 'Outside Campus',
                type: 'outside',
                images: imgs2('3RD BATCH SESSIONS 2025 (', 1, 56, ').jpg')
            },
            {
                name: 'General 2025 Photos',
                label: '',
                type: null,
                images: imgs2('2025 (', 1, 21, ').jpg')
            }
        ],
        '2026': [
            {
            ...
            {
                name: 'Bloodletting 2026',
                label: 'Outside Campus',
                type: 'outside',
                images: (function() {
                    var a = [];
                    for (var i = 1; i <= 8; i++) a.push(BASE + 'BLOODLETTING 2026 (' + i + ').jpg');
                    return a;
                }())
            },
            {
                name: 'Bureau of Fire Protection Seminar 2026',
                label: 'Outside Campus',
                type: 'outside',
                images: (function() {
                    var a = [];
                    for (var i = 1; i <= 11; i++) a.push(BASE + 'Bureau of Fire Protection Seminar 2026 (' + i + ').jpg');
                    return a;
                }())
            },
            {
                ...
                label: 'Outside Campus',
                type: 'outside',
                images: imgs2('4TH BATCH 2026(', 1, 30, ').jpg').concat(imgs2('4TH BATCH 2026(', 41, 51, ').jpg'))
            }
        ]
    };
    ...
    function loadEvent(ev) {
        ...
        // Update meta bar — badge is omitted when an event has no inside/outside type
        var nameHtml = '<span class="ev-meta-name">' + ev.name + '</span>';
        var badgeHtml = '';
        if (ev.type === 'inside' || ev.type === 'outside') {
        ...
        metaEl.innerHTML = nameHtml + badgeHtml;
    ...
    function captionText(idx) {
        var parts = [activeEvent.name];
        if (activeEvent.label) parts.push(activeEvent.label);
        parts.push((idx + 1) + ' / ' + activeEvent.images.length);
        return parts.join('  ·  ');
    }
    ...
    function openLightbox(idx) {
        ...
        lbCaption.textContent = captionText(currentIdx);
